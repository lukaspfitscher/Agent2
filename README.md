...
This is a concept, no code exists, just my thoughts of a preferd Agent!
Even this project description is inconsistent and contains bug,
...
launch \
  ...
  -max_tokens 2000 \
  # Add a prompt / if not set the user will prompted
  -prompt "return the sum of 34 + 45"

You can also give a name (-name "example_name")
 - this is required so an agent can be stop ( -stopp "agent_name") by another agent
...
***CLI interface***
- If the model doesnt requests a command the USER is promped.
